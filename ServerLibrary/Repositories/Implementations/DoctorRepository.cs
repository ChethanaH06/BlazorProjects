...
namespace ServerLibrary.Repositories.Implementations
{
    public class DoctorRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<Doctor>
    {
        ...
        public async Task<Doctor> GetById(int id) => await appDbContext.Doctors.FirstOrDefaultAsync(c => c.EmployeeId == id);
        ...
        {
            var obj=await appDbContext.Doctors.FirstOrDefaultAsync(n=>n.EmployeeId == item.EmployeeId);
