...
namespace ServerLibrary.Repositories.Implementations
{
    public class OvertimeRepository(AppDbContext appDbContext):IGenericRepositoryInterface<Overtime>
    {
        ...
        public async Task<Overtime> GetById(int id) => await appDbContext.Overtimes.FirstOrDefaultAsync(c => c.EmployeeId == id);
        ...
        {
            var obj = await appDbContext.Overtimes.FirstOrDefaultAsync(n => n.EmployeeId == item.EmployeeId);
